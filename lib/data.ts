...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    dek: "소비자 호감도 높인 최신 마케팅 4",
    cardHeadline: "오픈채팅방으로 찐팬 관리한다?",
    cardSub: "소비자 호감도 높인 최신 마케팅 4",
    date: "2026.08.31",
    author: "캐릿 에디터팀",
    label: "유행중",
    cardTone: "lime",
    cardEyebrow: "찐팬 관리",
    cardLine: "트렌드",
    cover: "/articles/truefan/thumb.png",
    thumbCard: true,
    heroQuote: "",
    lead: "",
    sections: [],
  ...
  },
  {
    ...
    dek: "인도네시아, 태국, 베트남, 싱가포르 소비자 분석표",
    cardHeadline: "다음 10년의 기회는 동남아시아에 있다!",
    cardSub: "인도네시아, 태국, 베트남, 싱가포르 소비자 분석표",
    date: "2026.08.31",
    author: "캐릿 에디터팀",
    label: "유행중",
    cardTone: "pink",
    cardEyebrow: "동남아시아",
    cardLine: "소비자 트렌드",
    cover: "/articles/asean/thumb.png",
    thumbCard: true,
    heroQuote: "",
    lead: "",
    sections: [],
  ...
  },
  {
    ...
    dek: "비수기 없는 대세 콘셉트 '괴담'을 분석하다",
    cardHeadline: "전 세계 알고리즘을 흔들고 있다!",
    cardSub: "비수기 없는 대세 콘셉트 ‘괴담’을 분석하다",
    date: "2026.08.31",
    author: "캐릿 에디터팀",
    label: "유행중",
    cardTone: "green",
    cardEyebrow: "괴담 트렌드",
    cardLine: "요즘 대세",
    cover: "/articles/ghost/thumb.png",
    thumbCard: true,
    heroQuote: "",
    lead: "",
    sections: [],
