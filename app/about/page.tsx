      ...
      <div className="catalog about">
        <div className="wrap">
          ...
          <p className="lede">
            ...
            ‘일잘 TIP’으로 옮겨, 읽고 끝내지 않고 한 주 안에 착수하게 만듭니다.
          </p>
          <div className="about-grid">
            ...
            <section>
              <h2>실행 층</h2>
              <p>
                아티클 오른쪽 레일에서 일잘TIP을 담고, 밑줄 노트에 문장을 남기고, 북마크로 다시 찾습니다.
                상단 게이지가 일잘 TIP.zip 진척을 보여 줍니다.
              </p>
            </section>
            <section>
              <h2>계정</h2>
              <p>
                ...
                있습니다. 일잘TIP·노트·저장은 이 브라우저에 남고, 에디터 계정만 클라우드와 맞춥니다.
              </p>
            </section>
          </div>
